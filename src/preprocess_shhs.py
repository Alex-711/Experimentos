...
def main():
    ...
    save_path = "/home/alex/datasets/save"
    data_dir_base = "/home/alex/datasets/shhs/shhs/polysomnography"
    ...
    #data_dir = os.path.join(data_dir, "/edfs/")
    data_dir = data_dir_base + "/edfs/shhs1"

    #ann_dir = os.path.join(data_dir,"/annots/")
    ann_dir = data_dir_base + "/annotations-events-profusion/shhs1"
    #output_dir = os.path.join(save_path,"/mid_level_data/")
    output_dir = save_path + "/mid_level_data/"
