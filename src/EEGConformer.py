...
class EEGConformer(nn.Module):
    ...
    def get_fc_size(self, input_window_samples = 3750):
...
#usar alinhamento euclidiano
#aumentar dados para 150s e pegar na parte de classificadores apenas o meio para classificiar
